...
class WasteRepository extends CommonRepository
{
    ...
    public function getWasteMaterialDetail($id, $fields = [])
    {
        ...
        $companyInfo = Company::getCopmanyInfo($result['company_id']);
        $result['company_name'] = is_null($companyInfo) ? '' : $companyInfo['name'];
        return $result;
    }
    ...
    public function getWasteGasReportByIndustry($params)
    {
        ...
        $fieldStr = 'SUM(protect_waste_gas.gas_discharge) as installations,protect_company.industry_category';
